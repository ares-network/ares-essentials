...
public final class WarpHandler {
    ...
    public void save() {
        ...
        Configs.saveConfig(manager.getPlugin(), "warps", config);
    ...
    public void list(Player player) {
        ...
        player.sendMessage(Essentials.PRIMARY + "Available Warps (" + Essentials.SECONDARY + manager.getWarps().size() + Essentials.PRIMARY + ")");
